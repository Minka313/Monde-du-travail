/**
 * BUILDER COMPLET DES MÉTIERS DU NUMÉRIQUE
 * Le Monde du Travail — Cartographie Pédagogique & Référentiel Métiers
 */
...
console.log('Construction des fiches métiers du numérique...');

const JOBS = [
  // =========================================================================
  // DOMAINE 1 : INFORMATIQUE & DÉVELOPPEMENT
  // =========================================================================
  makeJob({
    id: 'dev-fullstack',
    slug: 'developpeur-fullstack',
    title: 'Développeur Full-Stack',
    aliases: ['Full-Stack Developer', 'Développeur Web & Mobile Fullstack', 'Ingénieur Full Stack', 'Développeur Polyvalent'],
    icon: '💻',
    ...
    skills: {
      technical: ['JavaScript / TypeScript', 'React / Vue / Next.js', 'Node.js / Python / Java', 'Bases SQL (PostgreSQL, MySQL) & NoSQL (MongoDB)', 'Conception d’APIs REST & GraphQL', 'Git, Docker & Déploiement Cloud'],
      analytical: ['Résolution logique de bugs complexes', 'Optimisation des temps de réponse et performances', 'Compréhension globale de l’architecture logicielle'],
      creative: ['Capacité à transformer une idée abstraite en prototype interactif', 'Sensibilité à l’ergonomie utilisateur'],
      human: ['Autonomie et curiosité technologique', 'Communication claire avec les profils non techniques', 'Esprit d’équipe agile'],
      tools: ['VS Code', 'Git / GitHub / GitLab', 'Postman', 'Docker', 'Vercel / Supabase / AWS']
    },
    specializations: ['Front-end First', 'Back-end First', 'Architecture Cloud & Serverless', 'Performance Web'],
    studies: {
      schoolSubjects: ['Mathématiques', 'Sciences & Informatique (NSI)', 'Anglais technique'],
      pathway: [
        { step: 'Baccalauréat', title: 'Bac S, T, L (avec logique)', desc: 'Bases solides en mathématiques, logique et pratique de l’anglais.' },
        { step: 'Bac +2 / +3', title: 'BTS / DUT Informatique / Licence Génie Logiciel / Bootcamps certifiants', desc: 'Apprentissage approfondi des algorithmes, structures de données et langages web.' },
        { step: 'Bac +5', title: 'Master Informatique ou Diplôme d’Ingénieur', desc: 'Architecture distribuée, sécurité applicative et gestion de projet d’envergure.' }
      ],
      schools: [
        ...
        { name: 'Simplon Sénégal & Sonatel Academy', country: 'Sénégal', scope: 'Sénégal' },
        { name: 'École Supérieure du Digital (ESD)', country: 'France', scope: 'International' }
      ],
      certifications: ['AWS Certified Developer Associate', 'Meta Full-Stack Developer Certificate']
    },
    career: {
      sectors: ['Startups tech & FinTech', 'Télécoms & Mobile Money', 'Sociétés de Services Numériques (ESN)', 'Agences web', 'Secteur bancaire'],
      employerTypes: ['Startups en croissance', 'Entreprises de services numériques', 'Grandes entreprises télécoms', 'Freelance international remote'],
    ...
    gettingStarted: {
      ...
      portfolioIdeas: ['Présenter un dépôt GitHub soigné avec README explicatif, démo en ligne sur Vercel et code propre.']
    },
    aiImpact: {
    ...
    africaContext: {
      localSectors: ['FinTech (Wave, Orange Money, InTouch)', 'AgriTech & Logistique locale', 'E-commerce panafricain'],
      employerTypes: ['Startups de la tech sénégalaise', 'Filiales locales de multinationales', 'Missions de consulting en freelance remote'],
    ...
    relatedJobSlugs: ['developpeur-frontend', 'developpeur-backend', 'software-engineer', 'ingenieur-ia', 'devops-engineer'],
    interests: ['technologie-code', 'resoudre-problemes', 'creer-designer']
  }),
  ...
  makeJob({
    ...
    aliases: ['Front-End Developer', 'Intégrateur Front', 'Développeur UI / Client-side'],
    icon: '🖥️',
    ...
    skills: {
      technical: ['HTML5 sémantique & CSS3 avancé', 'JavaScript moderne (ES6+) & TypeScript', 'React / Next.js / Vue.js', 'Responsive Web Design & Mobile First', 'Accessibilité web (WCAG / RGAA)', 'Optimisation des performances web (Core Web Vitals)'],
      analytical: ['Débogage dans les DevTools du navigateur', 'Analyse des temps de rendu et de fluidité des animations'],
      creative: ['Sens aigu du détail visuel et des micro-animations', 'Respect scrupuleux des grilles graphiques et typographiques'],
      human: ['Collaboration étroite avec les UI/UX designers', 'Patience et rigueur d’intégration'],
      tools: ['VS Code', 'Chrome DevTools', 'Figma (lecture et inspection)', 'Git & GitHub', 'Tailwind CSS / Sass']
    },
    specializations: ['Performance & Core Web Vitals', 'Accessibilité numérique (a11y)', 'Design Systems & Composants', 'Animation Web (GSAP, Three.js)'],
    relatedJobSlugs: ['developpeur-fullstack', 'integrateur-web', 'ui-designer', 'product-designer'],
    interests: ['creer-designer', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    aliases: ['Back-End Developer', 'Développeur Serveur & API', 'Ingénieur Backend'],
    icon: '⚙️',
    ...
    skills: {
      technical: ['Node.js, Python (Django/FastAPI), Java (Spring Boot) ou Go', 'Bases de données relationnelles (PostgreSQL) et NoSQL (Redis, MongoDB)', 'Conception d’APIs RESTful et GraphQL', 'Sécurité web (OWASP, chiffrement, JWT, OAuth2)', 'Architecture microservices et serverless', 'Gestion de cache et optimisation des requêtes'],
      analytical: ['Algorithmique avancée et modélisation de données', 'Gestion de la concurrence et montée en charge (scalabilité)'],
      creative: ['Conception de schémas de bases de données élégants et évolutifs'],
      human: ['Rigueur absolue sur la sécurité', 'Clarté dans la documentation des APIs'],
      tools: ['Postman / Insomnia', 'Docker', 'DBeaver / pgAdmin', 'Linux / Bash', 'GitLab CI / GitHub Actions']
    },
    specializations: ['APIs & Microservices', 'Bases de données & Haute Performance', 'Sécurité & Chiffrement', 'Systèmes distribués'],
    relatedJobSlugs: ['developpeur-fullstack', 'data-engineer', 'devops-engineer', 'cloud-engineer'],
    interests: ['resoudre-problemes', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    aliases: ['Web Developer', 'Programmeur Web'],
    icon: '🌐',
    ...
    skills: {
      technical: ['HTML5, CSS3, JavaScript', 'PHP / MySQL ou Node.js', 'CMS (WordPress, Strapi)', 'Notions de SEO technique', 'Intégration d’APIs tierces (formulaires, paiements, cartographies)'],
      analytical: ['Résolution rapide des anomalies de compatibilité', 'Optimisation de la vitesse de chargement'],
      creative: ['Mise en page dynamique et harmonieuse'],
      human: ['Écoute des besoins clients', 'Pédagogie et réactivité'],
      tools: ['VS Code', 'Git', 'FileZilla / SSH', 'cPanel / Vercel', 'WordPress']
    },
    relatedJobSlugs: ['developpeur-fullstack', 'integrateur-web', 'webmaster'],
  ...
  makeJob({
    ...
    aliases: ['Intégrateur HTML/CSS', 'Frontend Integrator', 'Développeur Intégrateur'],
    icon: '📐',
    ...
    skills: {
      technical: ['Maîtrise experte de HTML5 et CSS3 (Flexbox, CSS Grid)', 'Animations CSS fluides', 'Préprocesseurs Sass / PostCSS', 'Bases de JavaScript pour les interactions', 'Normes d’accessibilité WCAG'],
      analytical: ['Contrôle qualité multi-écrans et multi-navigateurs'],
      creative: ['Sensibilité esthétique et respect du pixel-perfect'],
      human: ['Rigueur, souci du détail et patience'],
      tools: ['Figma', 'VS Code', 'Git', 'Lighthouse', 'BrowserStack']
    },
    relatedJobSlugs: ['developpeur-frontend', 'webdesigner', 'developpeur-web'],
    interests: ['creer-designer', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    aliases: ['Web Architect', 'Lead Architecte Solutions Web', 'Architecte Technique Web'],
    icon: '🏛️',
    ...
    skills: {
      technical: ['Architectures distribuées & microservices', 'Cloud computing (AWS, Azure, GCP)', 'Haute disponibilité et reprise après sinistre (DRP)', 'Sécurité applicative et chiffrement', 'Gouvernance des APIs', 'Bases de données massives (SQL sharding, NoSQL)'],
      analytical: ['Vision systémique et capacité d’anticipation des goulots d’étranglement'],
      creative: ['Résolution innovante de contraintes techniques complexes'],
      human: ['Leadership d’influence, pédagogie et négociation avec les directions'],
      tools: ['Diagrammes d’architecture (UML, C4 model)', 'Docker & Kubernetes', 'Terraform', 'Kafka / RabbitMQ']
    },
    relatedJobSlugs: ['software-architect', 'cloud-architect', 'developpeur-fullstack'],
    interests: ['resoudre-problemes', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    slug: 'webmaster',
    title: 'Webmaster',
    aliases: ['Administrateur de Site Web', 'Gestionnaire de Site Web', 'Webmaster Technique & Éditorial'],
    icon: '🛠️',
    ...
    skills: {
      technical: ['CMS (WordPress, Drupal)', 'HTML/CSS de base', 'Gestion de noms de domaine et DNS', 'Outils d’analyse d’audience (Google Analytics)', 'Sauvegardes et sécurité des accès'],
      analytical: ['Surveillance des indicateurs de disponibilité et de fréquentation'],
      creative: ['Mise en valeur attrayante des contenus'],
      human: ['Polyvalence, réactivité et sens du service'],
      tools: ['WordPress', 'Google Search Console', 'FileZilla', 'Canva / Photoshop (retouche d’images)']
    },
    relatedJobSlugs: ['developpeur-web', 'content-manager', 'integrateur-web'],
    interests: ['technologie-code', 'creer-designer']
  }),
  ...
  makeJob({
    ...
    aliases: ['Programmeur Informatique', 'Développeur Logiciel Polyvalent', 'Analyste Développeur'],
    icon: '⌨️',
    ...
    skills: {
      technical: ['Java, C#, Python, C++ ou PHP', 'Bases de données SQL', 'Algorithmique et structures de données', 'Tests unitaires et d’intégration', 'Modélisation UML'],
      analytical: ['Rigueur d’esprit et décomposition de problèmes complexes'],
      creative: ['Optimisation de l’efficacité des algorithmes'],
      human: ['Autonomie, discipline intellectuelle et travail en équipe'],
      tools: ['IntelliJ IDEA / Eclipse / VS Code', 'Git', 'Maven / Gradle', 'MySQL / PostgreSQL']
    },
    relatedJobSlugs: ['software-engineer', 'concepteur-developpeur', 'developpeur-fullstack'],
    interests: ['resoudre-problemes', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    aliases: ['Software Engineer', 'Ingénieur d’Études et Développement', 'Génie Logiciel'],
    icon: '🧠',
    ...
    skills: {
      technical: ['Génie logiciel & Design Patterns (SOLID)', 'Langages typés avancés (Go, Rust, TypeScript, Java, C++)', 'Architecture logicielle & DDD (Domain-Driven Design)', 'Tests automatisés (TDD, BDD, tests de charge)', 'Pipelines CI/CD & Déploiements automatisés'],
      analytical: ['Pensée systémique et analyse de la complexité algorithmique'],
      creative: ['Élégance de la conception logicielle'],
      human: ['Capacité à encadrer techniquement des développeurs juniors', 'Communication claire des choix techniques'],
      tools: ['Git', 'Docker', 'SonarQube', 'Linux', 'Kubernetes']
    },
    specializations: ['Distributed Systems', 'Backend Systems', 'Embedded Software', 'High-Performance Computing'],
    relatedJobSlugs: ['software-architect', 'developpeur-fullstack', 'devops-engineer'],
    interests: ['resoudre-problemes', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    aliases: ['Lead Concepteur', 'Analyste Concepteur Développeur'],
    icon: '📝',
    ...
    skills: {
      technical: ['Modélisation (UML, Merise)', 'Développement objet (Java, C#, Python)', 'Bases de données relationnelles', 'Rédaction de spécifications techniques', 'Méthodes Agiles (Scrum)'],
      analytical: ['Esprit de synthèse et capacité à formaliser des flux complexes'],
      creative: ['Conception de solutions fonctionnelles ergonomiques'],
      human: ['Excellente écoute et capacité de vulgarisation'],
      tools: ['Jira / Confluence', 'Enterprise Architect / Draw.io', 'Git', 'Postman']
    },
    relatedJobSlugs: ['concepteur-dapplications-informatiques', 'software-engineer', 'business-analyst'],
    interests: ['resoudre-problemes', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    aliases: ['Concepteur d’Applications', 'Architecte Applicatif Junior'],
    icon: '📱',
    ...
    skills: {
      technical: ['Architecture applicative', 'Conception d’interfaces applicatives', 'APIs et connecteurs de données', 'Programmation web ou mobile moderne'],
      analytical: ['Anticipation des cas limites et erreurs d’utilisation'],
      creative: ['Simplification de processus fastidieux pour l’usager'],
      human: ['Pédagogie et esprit collaboratif'],
      tools: ['Figma', 'VS Code', 'Swagger / OpenAPI', 'Miro']
    },
    relatedJobSlugs: ['concepteur-developpeur', 'product-owner', 'developpeur-fullstack'],
    interests: ['resoudre-problemes', 'creer-designer', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    aliases: ['Software Architect', 'Architecte Système Logiciel', 'Lead Architect'],
    icon: '🏗️',
    ...
    skills: {
      technical: ['Microservices, Event-Driven Architecture, CQRS', 'Sécurité des systèmes distribués', 'Performance et tolérance aux pannes', 'Gouvernance technologique'],
      analytical: ['Évaluation des compromis coûts / performances / délais'],
      creative: ['Création de modèles d’architecture épurés'],
      human: ['Pédagogie de haut niveau, écoute et autorité technique bienveillante'],
      tools: ['C4 Model', 'PlantUML', 'Kubernetes', 'Apache Kafka', 'Cloud Providers']
    },
    relatedJobSlugs: ['architecte-web', 'cloud-architect', 'software-engineer'],
    interests: ['resoudre-problemes', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    aliases: ['Mobile Developer', 'Développeur Mobile', 'Développeur iOS & Android'],
    icon: '📲',
    ...
    skills: {
      technical: ['Flutter (Dart), React Native, Kotlin (Android) ou Swift (iOS)', 'Gestion du stockage local (SQLite, Realm)', 'Consommation d’APIs et notifications push', 'Publication sur Google Play Store et Apple App Store', 'Optimisation des performances et autonomie batterie'],
      analytical: ['Débogage sur une multitude de modèles d’appareils différents'],
      creative: ['Animations gestuelles intuitives et fluides'],
      human: ['Sens de l’expérience utilisateur tactile'],
      tools: ['Android Studio', 'Xcode', 'Flutter / Dart', 'Firebase (Crashlytics, FCM)', 'Figma']
    },
    specializations: ['Cross-Platform (Flutter / React Native)', 'Natif Android (Kotlin)', 'Natif iOS (Swift)', 'Sécurité mobile & FinTech'],
    africaContext: {
      localSectors: ['Paiement mobile (Wave, Orange Money)', 'Services de livraison et transport (Yassir, Heetch)', 'E-commerce local'],
      employerTypes: ['FinTechs sénégalaises', 'Startups de livraison', 'Agences mobiles', 'Télétravail international'],
    ...
    relatedJobSlugs: ['developpeur-flutter', 'developpeur-react-native', 'developpeur-fullstack', 'ui-designer'],
    interests: ['technologie-code', 'creer-designer']
  }),
  ...
  makeJob({
    ...
    aliases: ['Flutter Developer', 'Ingénieur Flutter', 'Dart Developer'],
    icon: '⚡',
    ...
    skills: {
      technical: ['Dart & Framework Flutter', 'State Management (Bloc, Riverpod, Provider)', 'Animations personnalisées Flutter', 'Intégration d’APIs REST & GraphQL', 'Publication sur stores mobiles'],
      analytical: ['Optimisation du taux de rafraîchissement (60fps / 120fps)'],
      creative: ['Création de composants visuels sur mesure'],
      human: ['Esprit d’efficacité et d’agilité'],
      tools: ['VS Code / Android Studio', 'Dart DevTools', 'Firebase', 'GitHub Actions']
    },
    relatedJobSlugs: ['developpeur-dapplications-mobiles', 'developpeur-react-native', 'developpeur-frontend'],
    interests: ['technologie-code', 'creer-designer']
  }),
  ...
  makeJob({
    ...
    aliases: ['React Native Developer', 'Mobile React Engineer'],
    icon: '⚛️',
    ...
    skills: {
      technical: ['React Native & Expo', 'JavaScript moderne & TypeScript', 'Bridges natifs (liaison avec code natif)', 'State management (Redux, Zustand)', 'Navigation mobile (React Navigation)'],
      analytical: ['Résolution des spécificités d’affichage entre iOS et Android'],
      creative: ['Ergonomie fluide et interfaces modernes'],
      human: ['Collaboration facile entre équipes web et mobile'],
      tools: ['Expo', 'VS Code', 'React DevTools', 'Flipper', 'GitHub']
    },
    relatedJobSlugs: ['developpeur-dapplications-mobiles', 'developpeur-flutter', 'developpeur-frontend'],
    interests: ['technologie-code', 'creer-designer']
  }),
  ...
  makeJob({
    ...
    aliases: ['Android Developer', 'Ingénieur Android Natif', 'Kotlin Developer'],
    icon: '🤖',
    ...
    skills: {
      technical: ['Kotlin & Java', 'Jetpack Compose', 'Architecture MVVM / MVI', 'Room DB & SQLite', 'Google Play Services'],
      analytical: ['Gestion fine des ressources mémoires sur appareils d’entrée de gamme'],
      creative: ['Application stricte des directives Material Design 3'],
      human: ['Persévérance et veille sur les évolutions Android'],
      tools: ['Android Studio', 'Gradle', 'Firebase', 'Git']
    },
    relatedJobSlugs: ['developpeur-dapplications-mobiles', 'developpeur-ios', 'developpeur-flutter'],
  ...
  makeJob({
    ...
    aliases: ['iOS Developer', 'Ingénieur iOS Natif', 'Swift Developer'],
    icon: '🍎',
    ...
    skills: {
      technical: ['Swift & SwiftUI', 'Combine & Concurrency', 'Human Interface Guidelines (HIG)', 'Core Data / SwiftData', 'App Store Connect & TestFlight'],
      analytical: ['Optimisation de la fluidité à 120 Hz (ProMotion)'],
      creative: ['Sens exceptionnel des finitions visuelles et haptiques'],
      human: ['Exigence esthétique et rigueur technique'],
      tools: ['Xcode', 'Instruments', 'CocoaPods / Swift Package Manager', 'Git']
    },
    relatedJobSlugs: ['developpeur-dapplications-mobiles', 'developpeur-android', 'product-designer'],
    interests: ['technologie-code', 'creer-designer']
  }),

  // =========================================================================
  // DOMAINE 2 : INTELLIGENCE ARTIFICIELLE & MACHINE LEARNING
  // =========================================================================
  makeJob({
    id: 'prompt-engineer',
    slug: 'prompt-engineer',
    title: 'Prompt Engineer & Spécialiste IA Générative',
    aliases: ['Prompt Designer', 'Ingénieur de Prompts', 'Spécialiste IA Générative', 'AI Interaction Designer'],
    icon: '✍️',
    ...
    skills: {
      technical: ['Compréhension des architectures LLM (Transformers, tokens, context window)', 'Techniques avancées de prompting (Few-Shot, CoT, ReAct)', 'Python & APIs OpenAI, Anthropic, Mistral', 'Bases vectorielles (Pinecone, ChromaDB)', 'Évaluation de la précision (evals, benchmark)'],
      analytical: ['Détection fine des biais et hallucinations des modèles'],
      creative: ['Formulation d’instructions structurées et inventives'],
      human: ['Excellente maîtrise du langage écrit', 'Esprit critique et discernement éthique'],
      tools: ['LangChain / LlamaIndex', 'Python', 'Jupyter Notebook', 'OpenAI API / Claude API', 'Hugging Face']
    },
    specializations: ['RAG (Retrieval-Augmented Generation)', 'Agents IA autonomes', 'Prompting pour le code', 'Fine-tuning assisté'],
    relatedJobSlugs: ['ai-engineer', 'generative-ai-engineer', 'data-scientist'],
    interests: ['technologie-code', 'resoudre-problemes', 'creer-designer']
  }),
  ...
  makeJob({
    ...
    aliases: ['Ingénieur IA Applicative', 'AI Software Engineer', 'Ingénieur Solutions IA'],
    icon: '🤖',
    ...
    skills: {
      technical: ['Python, C++, TypeScript', 'Frameworks IA (PyTorch, TensorFlow, Hugging Face)', 'Intégration d’architectures RAG et agents IA', 'Déploiement sur GPU et optimisation (ONNX, TensorRT)', 'Bases de données vectorielles', 'APIs et conteneurs Docker'],
      analytical: ['Résolution des compromis entre précision du modèle et vitesse d’exécution'],
      creative: ['Conception de nouveaux cas d’usage à fort impact sociétal'],
      human: ['Veille scientifique permanente', 'Sensibilité aux enjeux éthiques de l’IA'],
      tools: ['PyTorch', 'Docker', 'Kubernetes', 'Hugging Face Hub', 'LangGraph']
    },
    specializations: ['Vision par ordinateur', 'Traitement du Langage Naturel (NLP)', 'IA pour la santé', 'Agents intelligents autonomes'],
    relatedJobSlugs: ['ingenieur-ia', 'machine-learning-engineer', 'mlops-engineer'],
    interests: ['technologie-code', 'resoudre-problemes']
  }),
  ...
  makeJob({
    ...
    aliases: ['ML Engineer', 'Ingénieur en Apprentissage Automatique'],
    icon: '📈',
    ...
    skills: {
      technical: ['Mathématiques (Algèbre linéaire, probabilités, calcul différentiel)', 'Python, R, C++', 'Scikit-Learn, PyTorch, XGBoost', 'Feature Engineering & Préparation des données', 'Métriques d’évaluation (ROC-AUC, F1-Score, RMSE)'],
      analytical: ['Rigueur scientifique absolue et esprit expérimental'],
      creative: ['Imagination d’indicateurs prédictifs originaux'],
      human: ['Patience lors des entraînements de modèles', 'Capacité de synthèse'],
      tools: ['Jupyter', 'MLflow', 'Pandas & NumPy', 'Weights & Biases', 'AWS SageMaker']
    },
    relatedJobSlugs: ['data-scientist', 'ai-engineer', 'mlops-engineer'],
    interests: ['resoudre-problemes', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    aliases: ['Data & AI Developer', 'Développeur IA', 'Programmeur Data Intelligence'],
    icon: '🧬',
    ...
    skills: {
      technical: ['Python (Flask, FastAPI, Streamlit)', 'SQL & NoSQL', 'Intégration de modèles de Machine Learning', 'Traitement et nettoyage de données (Pandas, ETL)', 'Docker et déploiement'],
      analytical: ['Compréhension des flux de données et validation des sorties'],
      creative: ['Création de tableaux de bord intelligents et interactifs'],
      human: ['Polyvalence et curiosité pluridisciplinaire'],
      tools: ['VS Code', 'FastAPI', 'Pandas', 'Streamlit', 'Docker']
    },
    relatedJobSlugs: ['developpeur-fullstack', 'data-scientist', 'ai-engineer'],
    interests: ['technologie-code', 'resoudre-problemes']
  }),
  ...
  makeJob({
    ...
    aliases: ['MLOps Specialist', 'Ingénieur Déploiement IA', 'Machine Learning Infrastructure Engineer'],
    icon: '🔄',
    ...
    skills: {
      technical: ['Pipelines CI/CD pour le Machine Learning', 'Kubernetes & Kubeflow', 'Monitoring de modèles (Prometheus, Grafana, Evidently)', 'Orchestration (Airflow, Prefect)', 'Infrastructure as Code (Terraform)'],
      analytical: ['Détection précoce de la baisse d’exactitude d’un modèle'],
      creative: ['Automatisation complète de processus complexes'],
      human: ['Capacité à faire dialoguer Data Scientists et ingénieurs infrastructure'],
      tools: ['Kubeflow', 'MLflow', 'Docker & Kubernetes', 'DVC', 'Terraform']
    },
    relatedJobSlugs: ['devops-engineer', 'machine-learning-engineer', 'data-engineer'],
    interests: ['technologie-code', 'resoudre-problemes']
  }),

  // =========================================================================
  // DOMAINE 3 : DATA & ANALYTICS
  // =========================================================================
  makeJob({
    id: 'data-analyst',
    slug: 'data-analyst',
    title: 'Data Analyst / Business Intelligence Analyst',
    aliases: ['Analyste de Données', 'BI Analyst', 'Analytics Consultant', 'Data Business Analyst'],
    icon: '📊',
    ...
    skills: {
      technical: ['SQL avancé (jointures, fenêtrage, CTE)', 'Outils de Data Visualisation (Power BI, Tableau, Looker Studio)', 'Python / R (Pandas, Matplotlib, Seaborn)', 'Excel avancé (Power Query, formules complexes)', 'Statistiques descriptives et tests d’hypothèses'],
      analytical: ['Esprit critique aiguisé face aux chiffres', 'Détection d’anomalies et de corrélations'],
      creative: ['Storytelling par la donnée (Data Storytelling) et conception de dashboards clairs'],
      human: ['Capacité à vulgariser des analyses auprès de personnes non spécialistes'],
      tools: ['SQL (PostgreSQL, BigQuery)', 'Power BI / Tableau', 'Excel', 'Python', 'Jupyter']
    },
    specializations: ['Marketing Analytics', 'Product Analytics', 'Finance & Risque', 'Supply Chain Analytics'],
    relatedJobSlugs: ['data-scientist', 'business-analyst', 'data-engineer', 'web-analyst'],
  ...
  makeJob({
    ...
    aliases: ['Scientifique de Données', 'Data Science Specialist'],
    icon: '🔬',
    ...
    skills: {
      technical: ['Mathématiques & Statistiques avancées', 'Python & R pour la Data Science', 'Machine Learning (Scikit-Learn, LightGBM)', 'Traitement de données massives (Spark, SQL)', 'Deep Learning de base'],
      analytical: ['Rigueur expérimentale et modélisation scientifique'],
      creative: ['Capacité à formuler de nouvelles approches prédictives'],
      human: ['Esprit de synthèse et communication orientée valeur métier'],
      tools: ['Python', 'Jupyter', 'SQL', 'Git', 'Google Cloud / BigQuery']
    },
    relatedJobSlugs: ['data-analyst', 'machine-learning-engineer', 'data-engineer'],
    interests: ['resoudre-problemes', 'analyser-chiffres', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    aliases: ['Ingénieur Pipeline Données', 'Big Data Engineer', 'Architecte de Flux de Données'],
    icon: '🚰',
    ...
    skills: {
      technical: ['Python, SQL avancé, Scala ou Java', 'Orchestration de pipelines (Apache Airflow, dbt)', 'Entrepôts de données Cloud (Snowflake, BigQuery, Databricks)', 'Streaming de données (Kafka)', 'Bases distribuées et Data Lakes'],
      analytical: ['Optimisation des coûts de calcul et des performances de requêtes'],
      creative: ['Conception de flux automatisés résilients aux pannes'],
      human: ['Rigueur et esprit de service envers les équipes consommatrices'],
      tools: ['Airflow', 'dbt', 'Snowflake / BigQuery', 'Docker', 'Git']
    },
    relatedJobSlugs: ['data-analyst', 'data-scientist', 'cloud-engineer'],
    interests: ['technologie-code', 'resoudre-problemes']
  }),
  ...
  makeJob({
    ...
    slug: 'web-analyst',
    title: 'Web Analyst',
    aliases: ['Analyste Web & Trafic', 'Digital Analytics Specialist', 'Analyste d’Audience'],
    icon: '🖱️',
    ...
    skills: {
      technical: ['Google Analytics 4 (GA4)', 'Google Tag Manager (GTM)', 'A/B Testing & Optimisation du taux de conversion (CRO)', 'Tableaux de bord Looker Studio', 'Bases de JavaScript pour le taggage'],
      analytical: ['Analyse de tunnels de conversion et de cohortes'],
      creative: ['Hypothèses d’amélioration ergonomique et commerciale'],
      human: ['Clarté dans la communication des constats'],
      tools: ['GA4', 'GTM', 'Looker Studio', 'Hotjar', 'Mixpanel']
    },
    relatedJobSlugs: ['data-analyst', 'traffic-manager', 'growth-hacker', 'ux-designer'],
  ...
  makeJob({
    ...
    aliases: ['Analyste d’Affaires', 'Digital Business Analyst', 'Consultant MOA'],
    icon: '💼',
    ...
    skills: {
      technical: ['Modélisation des processus métier (BPMN)', 'Analyse de données (SQL, Excel avancé)', 'Méthodologies Agiles (Scrum, Kanban)', 'Rédaction de spécifications fonctionnelles', 'Calcul de ROI et analyse de rentabilité'],
      analytical: ['Capacité d’audit et d’identification des gaspillages'],
      creative: ['Proposition de réorganisations innovantes'],
      human: ['Excellente aisance relationnelle et conduite d’ateliers'],
      tools: ['Jira / Confluence', 'Miro / Visio', 'Excel', 'SQL', 'Power BI']
    },
    relatedJobSlugs: ['product-owner', 'data-analyst', 'product-manager'],
    interests: ['resoudre-problemes', 'analyser-chiffres', 'gestion-projet']
  }),

  // =========================================================================
  // DOMAINE 4 : CYBERSÉCURITÉ & RÉSILIENCE
  // =========================================================================
  makeJob({
    id: 'analyste-cybersecurite',
    slug: 'analyste-cybersecurite',
    title: 'Analyste Cybersécurité / SOC Analyst',
    aliases: ['SOC Analyst', 'Analyste Sécurité', 'Opérateur SOC', 'Cyber Defense Analyst'],
    icon: '🛡️',
    ...
    skills: {
      technical: ['Gestion des événements de sécurité (SIEM : Splunk, Wazuh, Elastic)', 'Réseaux informatiques (TCP/IP, pare-feu, DNS)', 'Analyse de journaux (logs Linux/Windows)', 'Détection de malwares et menaces (EDR)', 'Procédures de réponse à incident'],
      analytical: ['Esprit d’enquête et capacité à relier des indices dispersés'],
      creative: ['Anticipation des ruses déployées par les attaquants'],
      human: ['Calme sous pression et réactivité immédiate'],
      tools: ['Wireshark', 'Splunk / Wazuh', 'TheHive', 'Suricata / Snort', 'VirusTotal']
    },
    specializations: ['SOC Niveau 1 (Triage)', 'SOC Niveau 2 (Investigation)', 'Threat Intelligence', 'Digital Forensics'],
    relatedJobSlugs: ['pentester-hacker-ethique', 'incident-responder', 'security-engineer'],
    interests: ['securite-defense', 'resoudre-problemes', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    aliases: ['Ethical Hacker', 'Auditeur en Sécurité Offensive', 'Consultant Pentest', 'Red Teamer'],
    icon: '🎯',
    image: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&auto=format&fit=crop&q=80',
    familyId: 'cybersecurite-reseaux',
    familyName: 'Cybersécurité & Réseaux',
    ...
    skills: {
      technical: ['Méthodologies d’intrusion (OWASP Testing Guide, PTES)', 'Scripts d’automatisation (Python, Bash)', 'Audit de sécurité web, réseau et Active Directory', 'Connaissance approfondie des protocoles et failles (CVE, SQLi, XSS, SSRF)', 'Rédaction de rapports d’audit clairs pour dirigeants et techniciens'],
      analytical: ['Perspicacité et logique de contournement des défenses'],
      creative: ['Ingéniosité pour trouver des chemins d’attaque inattendus'],
      human: ['Éthique irréprochable et sens du devoir légal'],
    ...
    relatedJobSlugs: ['analyste-cybersecurite', 'application-security-engineer', 'security-engineer'],
    interests: ['securite-defense', 'technologie-code', 'resoudre-problemes']
  }),
  ...
  makeJob({
    ...
    aliases: ['Security Engineer', 'Ingénieur Cybersécurité', 'SecOps Specialist'],
    icon: '🔒',
    ...
    skills: {
      technical: ['Sécurité des réseaux et protocoles cryptographiques', 'Gestion des identités et des accès (IAM / Active Directory)', 'Hardening (durcissement) de systèmes Linux et Windows', 'Sécurité Cloud (AWS, Azure, GCP)', 'Veille sur les vulnérabilités du marché'],
      analytical: ['Évaluation objective des risques opérationnels'],
      creative: ['Conception de défenses multicouches imperméables'],
      human: ['Rigueur, pédagogie auprès des utilisateurs et fermeté sur les règles'],
      tools: ['Palo Alto / Fortinet', 'OpenVPN / WireGuard', 'Vault / Keycloak', 'Terraform', 'CrowdStrike']
    },
    relatedJobSlugs: ['analyste-cybersecurite', 'devsecops-engineer', 'cloud-security-engineer'],
  ...
  makeJob({
    ...
    aliases: ['Ingénieur DevSecOps', 'Security Automation Engineer'],
    icon: '⚡',
    ...
    skills: {
      technical: ['CI/CD sécurisé (GitLab CI, GitHub Actions)', 'Analyse de code statique et dynamique (SAST/DAST)', 'Sécurité des conteneurs et clusters Kubernetes', 'Infrastructure as Code sécurisée', 'Gestion sécurisée des secrets (Vault)'],
      analytical: ['Arbitrage entre vitesse de livraison et seuils de risque de sécurité'],
      creative: ['Automatisation astucieuse des contrôles de conformité'],
      human: ['Pédagogie bienveillante envers les développeurs'],
      tools: ['Snyk / SonarQube', 'HashiCorp Vault', 'Trivy', 'GitLab CI', 'Docker']
    },
    relatedJobSlugs: ['devops-engineer', 'security-engineer', 'software-engineer'],
    interests: ['securite-defense', 'technologie-code']
  }),

  // =========================================================================
  // DOMAINE 5 : CLOUD & INFRASTRUCTURE
  // =========================================================================
  makeJob({
    id: 'cloud-engineer',
    slug: 'cloud-engineer',
    title: 'Cloud Engineer (Ingénieur Cloud)',
    aliases: ['Ingénieur Cloud Computing', 'Cloud Operations Specialist'],
    icon: '☁️',
    image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format&fit=crop&q=80',
    familyId: 'numerique-ia',
    familyName: 'Numérique, Informatique & IA',
    ...
    skills: {
      technical: ['Plateformes Cloud (AWS, Microsoft Azure ou Google Cloud Platform)', 'Automatisation & Scripting (Bash, Python, Terraform)', 'Réseaux Cloud (VPC, sous-réseaux, passerelles, routage)', 'Conteneurisation (Docker, Kubernetes)', 'Gestion des coûts du cloud (FinOps)'],
      analytical: ['Optimisation de la consommation des ressources et de la facture cloud'],
      creative: ['Conception de solutions haute disponibilité résilientes'],
      human: ['Rigueur opérationnelle et réactivité en cas d’incident'],
      tools: ['AWS Console / CLI', 'Terraform', 'Docker', 'Linux', 'Datadog']
    },
    certifications: ['AWS Certified Solutions Architect', 'Microsoft Azure Administrator'],
    relatedJobSlugs: ['cloud-architect', 'devops-engineer', 'administrateur-systemes-reseaux'],
    interests: ['technologie-code', 'resoudre-problemes']
  }),
  ...
  makeJob({
    ...
    aliases: ['Architecte Solutions Cloud', 'Lead Cloud Architect'],
    icon: '🌐',
    image: 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=800&auto=format&fit=crop&q=80',
    familyId: 'numerique-ia',
    familyName: 'Numérique, Informatique & IA',
    ...
    skills: {
      technical: ['Architecture multi-cloud et cloud hybride', 'Stratégies de migration (Lift-and-Shift, Re-platforming, Re-architecting)', 'Gouvernance et sécurité cloud à grande échelle', 'Résilience globale et plans de reprise (DRP)'],
      analytical: ['Analyse de risques et modélisation financière globale'],
      creative: ['Conception de plans d’architecture épurés'],
      human: ['Leadership stratégique et influence auprès des comités de direction'],
      tools: ['AWS / Azure / GCP', 'Terraform', 'Lucidchart / C4', 'Kubernetes']
    },
    relatedJobSlugs: ['cloud-engineer', 'architecte-web', 'software-architect'],
    interests: ['resoudre-problemes', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    aliases: ['SysAdmin', 'Administrateur Réseaux & Télécoms', 'Network & System Administrator'],
    icon: '🖥️',
    ...
    skills: {
      technical: ['Administration Linux & Windows Server', 'Réseaux (VLAN, routage, sous-réseaux, DNS, DHCP)', 'Configuration d’équipements (Cisco, MikroTik, Ubiquiti)', 'Sauvegardes et virtualisation (VMware, Proxmox)', 'Assistance utilisateur et dépannage'],
      analytical: ['Méthode rigoureuse de diagnostic lors des coupures réseau'],
      creative: ['Optimisation de l’agencement physique et logique des baies de serveurs'],
      human: ['Sens du service, réactivité et pédagogie auprès des utilisateurs'],
      tools: ['Cisco Packet Tracer / GNS3', 'Wireshark', 'Proxmox / VMware', 'Active Directory', 'Putty / SSH']
    },
    certifications: ['Cisco CCNA', 'CompTIA Network+ / Security+'],
    relatedJobSlugs: ['cloud-engineer', 'analyste-cybersecurite'],
    interests: ['technologie-code', 'resoudre-problemes']
  }),

  // =========================================================================
  // DOMAINE 6 : DEVOPS & PLATFORM ENGINEERING
  // =========================================================================
  makeJob({
    id: 'devops-engineer',
    slug: 'devops-engineer',
    title: 'DevOps Engineer',
    aliases: ['Ingénieur DevOps', 'Spécialiste Intégration Continue', 'Automatisation CI/CD'],
    icon: '♾️',
    ...
    skills: {
      technical: ['Intégration & Déploiement continus (CI/CD : GitHub Actions, GitLab CI)', 'Conteneurisation (Docker, Kubernetes)', 'Infrastructure as Code (Terraform, Ansible)', 'Scripting avancé (Bash, Python, Go)', 'Supervision & Observabilité (Prometheus, Grafana)'],
      analytical: ['Détection des goulots d’étranglement dans la chaîne de production logicielle'],
      creative: ['Conception de pipelines d’automatisation fluides et autonomes'],
      human: ['Culture de la collaboration bienveillante et du partage'],
      tools: ['Docker', 'Kubernetes', 'Terraform', 'GitHub Actions', 'Grafana']
    },
    relatedJobSlugs: ['site-reliability-engineer', 'cloud-engineer', 'developpeur-fullstack'],
    interests: ['technologie-code', 'resoudre-problemes']
  }),
  ...
  makeJob({
    ...
    aliases: ['Ingénieur Fiabilité des Systèmes', 'SRE Specialist'],
    icon: '⏱️',
    ...
    skills: {
      technical: ['Gestion des métriques et alertes (SLI/SLO, Grafana, Prometheus)', 'Ingénierie du chaos et tests de résilience', 'Systèmes distribués à grande échelle', 'Scripting de haute performance (Go, Python)', 'Gestion de crise et gestion des incidents critiques'],
      analytical: ['Diagnostic rapide sous pression extrême'],
      creative: ['Création de scripts d’auto-guérison des serveurs'],
      human: ['Culture du post-mortem sans blâme (Blameless Post-Mortem)'],
      tools: ['Prometheus', 'Grafana', 'Kubernetes', 'PagerDuty', 'Terraform']
    },
    relatedJobSlugs: ['devops-engineer', 'cloud-architect', 'software-engineer'],
    interests: ['technologie-code', 'resoudre-problemes']
  }),

  // =========================================================================
  // DOMAINE 7 : UX/UI & PRODUCT DESIGN
  // =========================================================================
  makeJob({
    id: 'ux-designer',
    slug: 'ux-designer',
    title: 'UX Designer (User Experience Designer)',
    aliases: ['Designer d’Expérience Utilisateur', 'Ergonome Web', 'Concepteur UX'],
    icon: '🧭',
    ...
    skills: {
      technical: ['Recherche utilisateur (User Research, interviews, tests d’utilisabilité)', 'Architecture de l’information & User Flows', 'Création de personas et Experience Maps', 'Prototypage basse et moyenne fidélité (Wireframing)', 'Psychologie cognitive appliquée au numérique'],
      analytical: ['Analyse qualitative et quantitative des comportements utilisateurs'],
      creative: ['Capacité à inventer des parcours simples pour des problèmes compliqués'],
      human: ['Empathie profonde, écoute active et absence de préjugés'],
      tools: ['Figma', 'Miro / FigJam', 'Maze', 'Notion', 'Hotjar']
    },
    specializations: ['UX Research', 'UX Writing (conception des textes d’interface)', 'Ergonomie mobile', 'Accessibilité'],
    relatedJobSlugs: ['ui-designer', 'product-designer', 'researcher-designer'],
  ...
  makeJob({
    ...
    aliases: ['Designer d’Interface', 'Designer Graphique d’Interface', 'Concepteur Visuel Web'],
    icon: '🎨',
    image: 'https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?w=800&auto=format&fit=crop&q=80',
    familyId: 'culture-medias',
    familyName: 'Culture, Médias, Communication & Industries Créatives',
    ...
    skills: {
      technical: ['Maîtrise de Figma (Auto-layout, Components, Variables, Tokens)', 'Théorie des couleurs et harmonie visuelle', 'Typographie numérique et hiérarchie de lecture', 'Création et maintenance de Design Systems', 'Prototypage interactif haute fidélité'],
      analytical: ['Vérification des contrastes et de la lisibilité sur tous les écrans'],
      creative: ['Sens artistique prononcé et sens du détail millimétré'],
      human: ['Sensibilité esthétique et communication bienveillante'],
      tools: ['Figma', 'Adobe Creative Suite (Photoshop, Illustrator)', 'Principle', 'IconJar']
    },
    relatedJobSlugs: ['ux-designer', 'product-designer', 'webdesigner', 'developpeur-frontend'],
    interests: ['creer-designer', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    aliases: ['Concepteur UX/UI', 'Designer Polyvalent Interface & Expérience'],
    icon: '✨',
    image: 'https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?w=800&auto=format&fit=crop&q=80',
    familyId: 'culture-medias',
    familyName: 'Culture, Médias, Communication & Industries Créatives',
    ...
    skills: {
      technical: ['Recherche utilisateur et tests d’utilisabilité', 'Wireframing & Prototypage interactif sur Figma', 'Design visuel et typographie', 'Création de Design Systems', 'Passation fluide des maquettes aux développeurs (Design Handoff)'],
      analytical: ['Analyse des retours d’utilisateurs'],
      creative: ['Créativité globale alliant ergonomie et beauté'],
      human: ['Écoute, diplomatie et sens du travail en équipe'],
      tools: ['Figma', 'FigJam', 'Notion', 'Illustrator']
    },
    relatedJobSlugs: ['ux-designer', 'ui-designer', 'product-designer'],
    interests: ['creer-designer', 'resoudre-problemes']
  }),
  ...
  makeJob({
    ...
    aliases: ['Designer Produit Numérique', 'Lead Product Designer'],
    icon: '💎',
    ...
    skills: {
      technical: ['Maîtrise avancée de Figma et des Design Systems', 'Compréhension des modèles économiques de produits (SaaS, FinTech)', 'Analyse de données de comportement (Mixpanel, Hotjar)', 'Méthodes de conception itérative (Design Sprints)', 'Bases solides de développement front-end'],
      analytical: ['Mesure de l’impact business des décisions de design (ROI, conversion, rétention)'],
      creative: ['Capacité à imaginer des propositions de valeur uniques'],
      human: ['Leadership, communication d’influence et posture de partenaire stratégique'],
      tools: ['Figma', 'Miro', 'Mixpanel', 'Notion', 'Loom']
    },
    relatedJobSlugs: ['ux-ui-designer', 'product-manager', 'product-owner'],
    interests: ['creer-designer', 'resoudre-problemes', 'gestion-projet']
  }),

  // =========================================================================
  // DOMAINE 8 : DESIGN DIGITAL & CRÉATION GRAPHIQUE
  // =========================================================================
  makeJob({
    id: 'motion-designer',
    slug: 'motion-designer',
    title: 'Motion Designer',
    aliases: ['Animateur Graphique', 'Graphiste Vidéo & Mouvement', 'Motion Graphics Artist'],
    icon: '🎞️',
    ...
    skills: {
      technical: ['After Effects & Cinema 4D / Blender', 'Principes fondamentaux de l’animation (Disney’s 12 principles)', 'Illustrator & Photoshop pour la préparation des assets', 'Sound Design et synchronisation audio', 'Formats d’export web et réseaux sociaux (Lottie, MP4, WebM)'],
      analytical: ['Sens du rythme et de la narration visuelle'],
      creative: ['Sensibilité esthétique exceptionnelle et inventivité graphique'],
      human: ['Patience méticuleuse et réactivité face aux retours'],
      tools: ['Adobe After Effects', 'Adobe Premiere Pro', 'Blender', 'Illustrator', 'LottieFiles']
    },
    relatedJobSlugs: ['animateur-3d', 'content-creator', 'directeur-artistique'],
    interests: ['creer-designer', 'audiovisuel-cinema']
  }),
  ...
  makeJob({
    ...
    slug: 'webdesigner',
    title: 'Webdesigner',
    aliases: ['Designer de Sites Web', 'Graphiste Web'],
    icon: '🎨',
    image: 'https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?w=800&auto=format&fit=crop&q=80',
    familyId: 'culture-medias',
    familyName: 'Culture, Médias, Communication & Industries Créatives',
    ...
    skills: {
      technical: ['Conception de maquettes web', 'Retouche photo et illustration vectorielle', 'Notions solides de HTML5 et CSS3', 'Respect des contraintes techniques du web (poids, formats)'],
      analytical: ['Adaptation de la mise en page selon les publics visés'],
      creative: ['Inventivité visuelle et composition harmonieuse'],
      human: ['Sens du contact client et réactivité'],
      tools: ['Figma', 'Adobe Photoshop', 'Adobe Illustrator', 'Canva']
    },
    relatedJobSlugs: ['integrateur-web-developpeur-integrateur', 'ui-designer', 'brand-designer'],
  ...
  makeJob({
    ...
    aliases: ['Designer de Marque', 'Brand Identity Designer', 'Directeur d’Identité Visuelle'],
    icon: '🏷️',
    ...
    skills: {
      technical: ['Création de logos et systèmes d’identité visuelle', 'Conception de Brand Guidelines complètes', 'Typographie et choix de palettes de couleurs', 'Déclinaison cross-canal (print, web, mobile, goodies)'],
      analytical: ['Étude du positionnement des marques concurrentes'],
      creative: ['Capacité à résumer les valeurs d’une entreprise en un symbole fort'],
      human: ['Pédagogie pour faire adhérer les dirigeants à une vision de marque'],
      tools: ['Adobe Illustrator', 'Figma', 'Photoshop', 'InDesign']
    },
    relatedJobSlugs: ['directeur-artistique', 'ui-designer', 'motion-designer'],
    interests: ['creer-designer', 'commerce-marketing']
  }),
  ...
  makeJob({
    ...
    aliases: ['3D Artist', 'Infographiste 3D', '3D Generalist', 'Modélisateur 3D'],
    icon: '🧊',
    ...
    skills: {
      technical: ['Modélisation 3D polygonale et sculpturale', 'Texturing & Shading (PBR)', 'Rigging et animation de personnages', 'Éclairage et moteurs de rendu (Cycles, Arnold, Unreal Engine)', 'Optimisation pour la 3D en temps réel sur le web'],
      analytical: ['Compréhension spatiale et physique de la lumière'],
      creative: ['Créativité plastique et sens de l’anatomie en mouvement'],
      human: ['Patience d’artisan et rigueur d’organisation des fichiers'],
      tools: ['Blender', 'Autodesk Maya', 'Substance 3D Painter', 'Unreal Engine', 'ZBrush']
    },
    relatedJobSlugs: ['motion-designer', 'creative-technologist', 'content-creator'],
    interests: ['creer-designer', 'audiovisuel-cinema']
  }),

  // =========================================================================
  // DOMAINE 9 : AUDIOVISUEL & DIGITAL CONTENT
  // =========================================================================
  makeJob({
    id: 'content-creator',
    slug: 'content-creator',
    title: 'Créateur de Contenu Digital (Content Creator)',
    aliases: ['Content Creator', 'Créateur de Médias Digitaux', 'Vidéaste Web', 'Digital Producer'],
    icon: '📹',
    ...
    skills: {
      technical: ['Cadrage et tournage vidéo', 'Montage vidéo rythmé (Premiere Pro, CapCut)', 'Prise de son et mixage vocal propre', 'Techniques de Storytelling et de Hook (accroche)', 'Optimisation pour les algorithmes des plateformes'],
      analytical: ['Analyse des statistiques de rétention et d’engagement'],
      creative: ['Inventivité constante et adaptation aux tendances culturelles'],
      human: ['Aisance face caméra et authenticité'],
      tools: ['Premiere Pro / DaVinci Resolve', 'CapCut', 'Microphones sans fil', 'Canva', 'YouTube Studio']
    },
    relatedJobSlugs: ['motion-designer', 'social-media-manager', 'community-manager'],
    interests: ['creer-designer', 'audiovisuel-cinema', 'commerce-marketing']
  }),
  ...
  makeJob({
    ...
    aliases: ['Digital Production Coordinator', 'Producteur de Contenus Digitaux'],
    icon: '🎬',
    ...
    skills: {
      technical: ['Gestion de budget de production', 'Planification logistique et feuilles de route', 'Droit à l’image et contrats d’auteurs', 'Connaissance de la chaîne technique audiovisuelle'],
      analytical: ['Maîtrise des coûts et des calendriers serrés'],
      creative: ['Capacité à trouver des solutions logistiques ingénieuses'],
      human: ['Sens de l’organisation, diplomatie et leadership d’équipe'],
      tools: ['Excel / Google Sheets', 'Notion', 'Asana / Trello', 'Logiciels de devis']
    },
    relatedJobSlugs: ['content-creator', 'chef-de-projet-digital'],
    interests: ['gestion-projet', 'audiovisuel-cinema']
  }),

  // =========================================================================
  // DOMAINE 10 : MARKETING DIGITAL & ACQUISITION
  // =========================================================================
  makeJob({
    id: 'charge-marketing-digital',
    slug: 'charge-de-marketing-digital',
    title: 'Chargé de Marketing Digital',
    aliases: ['Digital Marketing Specialist', 'Coordinateur Marketing Digital', 'Chargé d’Acquisition & Visibilité'],
    icon: '📣',
    ...
    skills: {
      technical: ['Gestion de campagnes publicitaires (Meta Ads, Google Ads)', 'Emailing et marketing automation (Brevo, Mailchimp)', 'Gestion de réseaux sociaux professionnels', 'Notions de SEO et création de contenu', 'Analyse du retour sur investissement (ROI)'],
      analytical: ['Suivi rigoureux des taux de clics et de transformation'],
      creative: ['Rédaction de messages accrocheurs'],
      human: ['Curiosité, réactivité et sens commercial'],
      tools: ['Meta Business Suite', 'Google Ads', 'Mailchimp / Brevo', 'Canva', 'Google Analytics']
    },
    relatedJobSlugs: ['growth-hacker', 'traffic-manager', 'social-media-manager'],
  ...
  makeJob({
    ...
    aliases: ['Search Marketer', 'Expert Référencement Google', 'Consultant Search'],
    icon: '🔍',
    ...
    skills: {
      technical: ['Audit technique SEO (crawl, vitesse, balisage, indexation)', 'Recherche de mots-clés et stratégie sémantique', 'Gestion de campagnes Google Ads (Search, Display, Performance Max)', 'Netlinking et autorité de domaine', 'Suivi du positionnement et reporting'],
      analytical: ['Compréhension fine des algorithmes de recherche Google'],
      creative: ['Rédaction de titres et méta-descriptions irrésistibles au clic'],
      human: ['Patience face aux délais d’indexation et force de conseil'],
      tools: ['Google Search Console', 'Ahrefs / Semrush', 'Google Ads', 'Screaming Frog', 'GA4']
    },
    relatedJobSlugs: ['charge-de-compte-adwords', 'growth-hacker', 'web-analyst'],
  ...
  makeJob({
    ...
    aliases: ['Growth Marketer', 'Spécialiste Croissance Digitale', 'Responsable Growth'],
    icon: '🚀',
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&auto=format&fit=crop&q=80',
    familyId: 'commerce-marketing',
    familyName: 'Commerce, Vente, Marketing & E-Commerce',
    ...
    skills: {
      technical: ['Framework AARRR et méthodologie d’expérimentation rapide', 'Scraping de données et automatisation (Make, Zapier, Python)', 'A/B Testing et optimisation de conversion', 'Copywriting persuasif et landing pages rapides', 'Analyse de données de cohorte'],
      analytical: ['Orientation totale vers les indicateurs de croissance'],
      creative: ['Idées originales et non conventionnelles pour capter des prospects'],
      human: ['Résilience face aux échecs d’expériences et curiosité insatiable'],
      tools: ['Make / Zapier', 'Phantombuster', 'Google Tag Manager', 'PostHog / Mixpanel', 'Webflow']
    },
    relatedJobSlugs: ['charge-de-marketing-digital', 'product-manager', 'data-analyst'],
    interests: ['commerce-marketing', 'resoudre-problemes', 'technologie-code']
  }),
  ...
  makeJob({
    ...
    aliases: ['Responsable Médias Sociaux', 'Stratège Réseaux Sociaux', 'SMM'],
    icon: '📱',
    ...
    skills: {
      technical: ['Stratégie de contenu social et calendriers éditoriaux', 'Gestion de l’e-réputation et communication de crise', 'Publicité payante sur les réseaux sociaux (Social Ads)', 'Marketing d’influence et relations créateurs', 'Analyse des KPI d’engagement et de portée'],
      analytical: ['Compréhension des tendances et des métriques d’audience'],
      creative: ['Inventivité éditoriale et ton conversationnel adapté'],
      human: ['Excellente plume, diplomatie et réactivité'],
      tools: ['Buffer / Hootsuite / Metricool', 'Canva', 'Meta Business Suite', 'Notion', 'Brand24']
    },
    relatedJobSlugs: ['community-manager', 'content-creator', 'charge-de-marketing-digital'],
    interests: ['commerce-marketing', 'creer-designer']
  }),
  ...
  makeJob({
    ...
    aliases: ['Animateur de Communauté en Ligne', 'Modérateur Web & Réseaux Sociaux'],
    icon: '💬',
    ...
    skills: {
      technical: ['Animation de communautés (Discord, WhatsApp, Instagram, LinkedIn)', 'Modération et gestion des commentaires sensibles', 'Création de visuels et carrousels simples', 'Maîtrise parfaite de l’orthographe et de la grammaire'],
      analytical: ['Mesure de l’activité quotidienne de la communauté'],
      creative: ['Sens de l’humour bienveillant et de la répartie'],
      human: ['Empathie, patience et grand sens du contact humain'],
      tools: ['Canva', 'WhatsApp Business', 'Meta Suite', 'Discord', 'Trello']
    },
  ...
  // =========================================================================
  // DOMAINE 11 : E-COMMERCE & MARKETPLACE
  // =========================================================================
  makeJob({
    id: 'responsable-e-commerce',
    slug: 'responsable-e-commerce',
    title: 'Responsable E-Commerce',
    aliases: ['E-Commerce Manager', 'Directeur Vente en Ligne', 'Head of E-Commerce'],
    icon: '🛒',
    ...
    skills: {
      technical: ['Plateformes E-Commerce (Shopify, PrestaShop, WooCommerce)', 'Intégration de paiements locaux (Wave, Orange Money) et internationaux', 'Optimisation du tunnel de vente et gestion des paniers abandonnés', 'Gestion de stocks et logistique de livraison du dernier kilomètre', 'Calcul des marges et du coût d’acquisition client (CAC)'],
      analytical: ['Analyse quotidienne des indicateurs de vente et de rentabilité'],
      creative: ['Création d’offres promotionnelles irrésistibles'],
      human: ['Leadership commercial et négociation avec les fournisseurs'],
      tools: ['Shopify', 'Google Analytics 4', 'Klaviyo', 'Excel', 'Stripe / PayDunya']
    },
    relatedJobSlugs: ['traffic-manager', 'product-manager', 'charge-de-marketing-digital'],
    interests: ['commerce-marketing', 'gestion-projet']
  }),

  // =========================================================================
  // DOMAINE 12 : PRODUCT MANAGEMENT & DIGITAL BUSINESS
  // =========================================================================
  makeJob({
    id: 'product-manager',
    slug: 'product-manager',
    title: 'Product Manager (PM)',
    aliases: ['Chef de Produit Numérique', 'Digital Product Manager', 'Lead PM'],
    icon: '🎯',
    image: 'https://images.unsplash.com/photo-1531403009284-440f080d1e12?w=800&auto=format&fit=crop&q=80',
    familyId: 'commerce-marketing',
    familyName: 'Commerce, Vente, Marketing & E-Commerce',
    ...
    skills: {
      technical: ['Définition de Roadmap produit et priorisation (RICE, MoSCoW)', 'Compréhension solide de l’architecture logicielle et des APIs', 'Analyse de métriques produit (NPS, churn, rétention, LTV)', 'Méthodologies Agiles et pilotage de sprints', 'Animation d’ateliers de découverte utilisateur (Product Discovery)'],
      analytical: ['Arbitrage pragmatique entre ce qui est souhaitable et ce qui est faisable'],
      creative: ['Sens aigu de l’innovation utile et intuitive'],
      human: ['Excellente communication orale et écrite, écoute et négociation'],
      tools: ['Jira / Linear', 'Productboard / Notion', 'Mixpanel', 'Figma (lecture)', 'Miro']
    },
    relatedJobSlugs: ['product-owner', 'product-designer', 'business-analyst'],
    interests: ['gestion-projet', 'commerce-marketing', 'resoudre-problemes']
  }),
  ...
  makeJob({
    ...
    aliases: ['Responsable Produit Agile', 'Propriétaire de Produit'],
    icon: '📋',
    image: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&auto=format&fit=crop&q=80',
    ...
    skills: {
      technical: ['Méthode Scrum et rédaction de User Stories', 'Gestion et priorisation du Backlog produit', 'Définition des critères d’acceptation (Acceptance Criteria)', 'Participation active aux cérémonies agiles (Sprint Planning, Retro)', 'Tests de recette fonctionnelle'],
      analytical: ['Précision logique et traçabilité des exigences'],
      creative: ['Capacité à trouver des solutions simples pour livrer vite'],
      human: ['Disponibilité permanente pour l’équipe technique et bienveillance'],
      tools: ['Jira', 'Trello / Linear', 'Confluence', 'Figma']
    },
    certifications: ['PSPO (Professional Scrum Product Owner)', 'CSPO (Certified Scrum Product Owner)'],
    relatedJobSlugs: ['product-manager', 'chef-de-projet-digital', 'business-analyst'],
    interests: ['gestion-projet', 'resoudre-problemes']
  }),
  ...
  makeJob({
    ...
    aliases: ['Responsable Réussite Client', 'Gestionnaire Succès Client', 'Client Success Specialist'],
    icon: '🤝',
    ...
    skills: {
      technical: ['Outils CRM (HubSpot, Salesforce)', 'Analyse de la santé client (Customer Health Score)', 'Techniques d’onboarding et de formation logicielle', 'Gestion des risques de résiliation (Churn)'],
      analytical: ['Détection des signaux faibles d’insatisfaction'],
      creative: ['Création de guides d’utilisation clairs et inspirants'],
      human: ['Sens profond du service, empathie et aisance relationnelle'],
      tools: ['HubSpot', 'Zendesk', 'Gainsight', 'Loom', 'Slack']
    },
    relatedJobSlugs: ['account-manager', 'product-manager', 'consultant-crm'],
    interests: ['commerce-marketing', 'gestion-projet']
  }),
  ...
  makeJob({
    ...
    aliases: ['Chef de Projet Web & Multimédia', 'Digital Project Manager', 'Coordinateur de Projet Digital'],
    icon: '🗂️',
    ...
    skills: {
      technical: ['Gestion de projet classique et Agile', 'Élaboration de plannings (Gantt) et budgets', 'Culture générale web (code, design, référencement)', 'Recette et contrôle qualité des livrables'],
      analytical: ['Anticipation des retards et gestion des imprévus'],
      creative: ['Capacité à trouver des compromis acceptables par tous'],
      human: ['Organisation sans faille, leadership et diplomatie'],
      tools: ['Trello / Asana', 'MS Project / Notion', 'Miro', 'Excel']
    },
    relatedJobSlugs: ['product-owner', 'charge-de-production'],
    interests: ['gestion-projet', 'commerce-marketing']
  }),

  // =========================================================================
  // DOMAINE 13 : INNOVATION & TRANSFORMATION DIGITALE
  // =========================================================================
  makeJob({
    id: 'charge-dinnovation',
    slug: 'charge-dinnovation',
    title: 'Chargé d’Innovation Digitale',
    aliases: ['Innovation Manager', 'Responsable Innovation Numérique', 'Lead Innovateur'],
    icon: '💡',
    image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format&fit=crop&q=80',
    familyId: 'numerique-ia',
    familyName: 'Numérique, Informatique & IA',
    ...
    skills: {
      technical: ['Veille prospective sur les technologies émergentes', 'Méthodes de Design Thinking et prototypage rapide', 'Organisation de hackathons et d’appels à projets', 'Montage de partenariats écosystème startup / université'],
      analytical: ['Évaluation du potentiel économique des innovations'],
      creative: ['Vision disruptive et pensée hors des sentiers battus'],
      human: ['Enthousiasme contagieux, force de conviction et curiosité'],
      tools: ['Miro', 'Notion', 'Plateformes de veille tech', 'Outils de prototypage no-code']
    },
    relatedJobSlugs: ['consultant-strategie-digitale', 'chief-digital-officer-cdo'],
    interests: ['recherche-innovation', 'technologie-code', 'gestion-projet']
  }),
  ...
  makeJob({
    ...
    aliases: ['Directeur de la Transformation Digitale', 'Directeur du Numérique'],
    icon: '👑',
    ...
    skills: {
      technical: ['Stratégie d’entreprise et gouvernance numérique', 'Conduite du changement à grande échelle', 'Culture globale des architectures tech, cloud, data et IA'],
      analytical: ['Vision prospective sur les bouleversements de marché'],
      creative: ['Capacité à réinventer des modèles économiques entiers'],
      human: ['Leadership inspirant, intelligence émotionnelle et négociation'],
      tools: ['Outils de pilotage stratégique', 'Tableaux de bord de direction', 'Miro']
    },
    relatedJobSlugs: ['charge-dinnovation', 'consultant-strategie-digitale'],
    interests: ['gestion-projet', 'recherche-innovation']
  }),
  ...
  makeJob({
    ...
    aliases: ['Digital Strategy Consultant', 'Conseiller en Transformation Numérique'],
    icon: '🧭',
    image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&auto=format&fit=crop&q=80',
    familyId: 'droit-management',
    familyName: 'Droit, Administration, Management & Services Professionnels',
    ...
    skills: {
      technical: ['Diagnostic de maturité digitale', 'Benchmark concurrentiel international', 'Modélisation financière et business plan digital', 'Présentations percutantes pour comités de direction'],
      analytical: ['Esprit d’analyse stratégique et structuration d’arguments'],
      creative: ['Identification de relais de croissance inexploités'],
      human: ['Aisance relationnelle de haut niveau et sens du conseil'],
      tools: ['PowerPoint / Keynote', 'Excel avancé', 'Miro', 'Gartner / Forrester']
    },
    relatedJobSlugs: ['chief-digital-officer-cdo', 'business-analyst', 'charge-dinnovation'],
    interests: ['gestion-projet', 'recherche-innovation']
  })
];

console.log(`Total de métiers numériques structurés : ${JOBS.length}`);

// Génération du contenu du fichier JavaScript client
const fileContent = `/**
 * CATALOGUE DES MÉTIERS DU NUMÉRIQUE ENRICHI
 * Le Monde du Travail — Source de référence : ESD & Standards Technologiques
 * Généré automatiquement pour garantir intégrité, exhaustivité et absence de régression.
 */
...
(function () {
  ...
  const DIGITAL_JOBS = ${JSON.stringify(JOBS, null, 2)};
  ...
  console.log('✅ OrientationDigitalData chargé avec ' + DIGITAL_JOBS.length + ' métiers du numérique répartis sur ' + DIGITAL_DOMAINS.length + ' domaines.');
})();
`;

const outputPath = path.join(__dirname, '../frontend/js/orientation-digital-data.js');
fs.writeFileSync(outputPath, fileContent, 'utf8');

console.log('Fichier généré avec succès dans :', outputPath);
console.log('Taille :', Math.round(fs.statSync(outputPath).size / 1024), 'Ko');
